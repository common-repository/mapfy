...
(function ($, elementor) {
  ...
  var MapfyLeafletMap = function MapfyLeafletMap($scope, $) {
    var $openStreetMap = $scope.find('.mapfy-open-street-map'),
  ...
  jQuery(window).on('elementor/frontend/init', function () {
    elementorFrontend.hooks.addAction('frontend/element_ready/mapfy-leaflet-map.default', MapfyLeafletMap);
  });
